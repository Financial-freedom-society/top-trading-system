...
**🔒 UNBREAKABLE RULE**: Before working on ANY component or task in this repository, you MUST ALWAYS start with the comprehensive documentation index. This rule is enforced in `.cursor/rules/documentation-first-rule.md` and `.bmad-core/core-config.yaml`.
