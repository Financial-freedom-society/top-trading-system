...
**Before working on ANY component or task in this NautilusTrader repository, you MUST ALWAYS:**
...
This rule ensures:
- ✅ Proper understanding of NautilusTrader architecture
- ✅ Following established patterns and conventions
- ✅ Avoiding architectural violations
- ✅ Maintaining code consistency
- ✅ Leveraging existing capabilities before creating new ones
...
- `docs/data/documentation-first-rule.md` (this file)
- `.bmad-core/core-config.yaml` (agent configuration)

## No Exceptions

There are **NO EXCEPTIONS** to this rule. Every development task must start with documentation review, regardless of:
- Task complexity
- Time constraints  
- Familiarity with the codebase
- Type of modification (new feature, bug fix, refactoring, etc.)
